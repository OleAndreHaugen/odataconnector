...
// async function getFieldMeta(field) {

//     // Get Metadata
//     let tableName;

//     if (!field._parent) {
//         tableName = connector.config.table;
//     } else {
...
//         console.log("Done findOne", session)

//         // TODO 
//         if (cache) {
//             metadata[tableName] = cache.metadata;
//         } else {
//             console.log("CACHE not found", field)
//         }

//     }

//     const fieldmeta = metadata[tableName].fields.find((f) => f.name === field.fieldName);
